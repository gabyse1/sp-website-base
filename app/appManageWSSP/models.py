...
class Imagen(MediaResource):
    ...
    def delete(self, *args, **kwargs):
        if self.file_image: self.file_image.delete(save=False)
...
class Video(MediaResource):
    ...
    def delete(self, *args, **kwargs):
        if self.file_video: self.file_video.delete(save=False) 
        super().delete(*args, **kwargs)
...
class HtmlDesign(models.Model):
    ...
    def delete(self, *args, **kwargs):
        if self.file_html: self.file_html.delete(save=False)
        super().delete(*args, **kwargs)
