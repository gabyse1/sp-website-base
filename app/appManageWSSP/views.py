        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    ...
                    page.id = Page.objects.latest('id').id + 1
                    ...
                    if not existStyleSheet:
                        ...
                        filename = open(f"./appDisplayWSSP/static/appDisplayWSSP/css/{styleSheetName}.css","a", encoding="utf-8")
                        filename.write("/* ----- POSICIONAR ELEMENTOS DE DESCRIPCION ----- */" + os.linesep)
                        filename.close()
                        # create style sheet in database
                        newStyleSheet.id = StyleSheet.objects.latest('id').id + 1
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    ...
                    styleSheet.save()
                    os.rename(f"./appDisplayWSSP/static/appDisplayWSSP/css/{lastStyleSheetName}.css", f"./appDisplayWSSP/static/appDisplayWSSP/css/{styleSheet.name}.css")
                    # load updated record
                    return HttpResponseRedirect(reverse("adm_page", kwargs={"adm":"edit","id":page.id}))
                except:
            ...
            if adm == "delete":
                try:
                    ...
                    os.remove(f"./appDisplayWSSP/static/appDisplayWSSP/css/{page.styleSheetName}.css")
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    ...
                    section.id = Section.objects.latest('id').id + 1
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    ...
                    element.id = DescriptiveArticle.objects.latest('id').id + 1
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    # create record in database
                    element = form.save(commit=False)
                    element.id = GraphicArticle.objects('id').id + 1
                    element.section = section
                    element.user = request.user
                    element.save()
                    # load record
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    # create record in database
                    element = form.save(commit=False)
                    element.id = Slider.objects.latest('id').id + 1
                    element.section = section
                    element.user = request.user
                    element.save()
                    # load record
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    # update record in database
                    element = form.save(commit=False)
                    element.id = Outstanding.objects.latest('id').id + 1
                    element.section = section
                    element.user = request.user
                    element.save()
                    # load record
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    # create record in database
                    element = form.save(commit=False)
                    element.id = OutstandingArticle.objects.latest('id').id + 1
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    # create record in database
                    element = form.save(commit=False)
                    element.id =HtmlArticle.objects.latest('id').id + 1
                    element.section = section
                    element.user = request.user
                    element.save()
                    # load record
...
def adm_styleSheet(request, id):
    if request.user.is_authenticated:
        ...
        try:
            ...
            filename = open(f"./appDisplayWSSP/static/appDisplayWSSP/css/{styleSheet.name}.css", encoding='utf-8')
            lines = filename.read()
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    ...
                    filename = open(f"./appDisplayWSSP/static/appDisplayWSSP/css/{styleSheet.name}.css", "w", encoding="utf-8")
            ...
            if request.method == "POST":
                ...
                if form.is_valid():
                    try:
                        ...
                        elementtype.id = ElementType.objects.latest('id').id + 1
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    ...
                    country.id = Country.objects.latest('id').id + 1
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                try:
                    ...
                    region.id = Region.objects.latest('id').id + 1
            ...
            if form.is_valid():
                try:
                    ...
                    if existMatch is False:
                        ...
                        province.id = Province.objects.latest('id').id + 1
            ...
            if form.is_valid():
                try:
                    ...
                    if existMatch is False:
                        ...
                        district.id = District.objects.latest('id').id + 1
                ...
                try:
                    if "file_image" in request.FILES:
                        ...
                        if not existImage:
                            ...
                            image.id = Imagen.objects.latest('id').id + 1
            ...
            if form.is_valid():
                try:
                    ...
                    if not existVideo:
                        ...
                        video.id = Video.objects.latest('id').id + 1
                ...
                try:
                    if "file_html" in request.FILES:
                        ...
                        if not existHtml:
                            ...
                            htmlDesign.id = HtmlDesign.objects.latest('id').id + 1
    ...
    if request.user.is_authenticated:
        ...
        try:
            ...
            if htmlDesign.file_html:
                old_htmlDesign = htmlDesign.file_html
        except:
            raise Http404
                ...
                try:
                    ...
                    if existMatch is False:
                        ...
                        if removeServerHtmlDesign is True:
                            old_htmlDesign.delete(save=False)
                        # load record
                        return HttpResponseRedirect(reverse("adm_htmlDesign", kwargs={"adm":"edit","id":htmlDesign.id}))
                except:
                    form.errors["__all__"] = form.error_class(["There was a problem updating the record."])
            ...
            if request.method == "POST":
                ...
                if form.is_valid():
                    try:
                        ...
                        record.id = User.objects.latest('id').id + 1
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            try:
                ...
                contact.id = Contact.objects.latest('id').id + 1 if Contact.objects.count() > 0 else 1
                contact.save()

                # return successful answer
                return JsonResponse({"success": {"es":"Mensaje enviado", "en":"Message sent successfully."}})
