...
from utils.storage_backend import SupabaseStorage

# Create your views here.
 
def get_page(request, pagename='inicio', lang='es'):
    if lang == 'es':
    ...
    if webPage:
            ...
            for element in sectionElements:
                ...
                if element.elementType.htmlName == "descriptiveArticle":
                    ...
                    if gArticle.media.mediaType == "images":
                        ...
                        supabaseinstance = SupabaseStorage()
                        imgdownloaded = supabaseinstance.open(name=image.file_image.name)
                        imgsize = Image.open(imgdownloaded)
        ...
        return render(request, f"appDisplayWSSP/pagemodel{lang}.html", {
            "webLang": lang,
            "webPage": webPage,
            "listPages": listPages,
